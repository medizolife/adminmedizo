                    ...
                    <TableRow key={pharm.id || pharm._id} sx={{ '& td': { borderColor: themeColors.border, color: themeColors.textPrimary } }}>
                      ...
                      <TableCell>
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.2 }}>
                          <Typography variant="body2" sx={{ fontWeight: 700, color: themeColors.accentWarning, display: 'flex', alignItems: 'center', gap: 0.5, fontSize: '0.78rem' }}>
                            <AccessTimeIcon sx={{ fontSize: 13, color: themeColors.accentWarning }} />
                            {lastActiveDate ? formatDate(lastActiveDate) : 'Active Today'}
                          </Typography>
                          <Typography variant="caption" sx={{ color: isLight ? '#B45309' : '#F59E0B', fontWeight: 700, fontSize: '0.68rem' }}>
                          ...
                          <Typography variant="caption" sx={{ color: '#38BDF8', fontFamily: 'monospace', fontWeight: 700, fontSize: '0.66rem' }}>
                            IP: {pharm.lastLoginIp || pharm.ipAddress || getUserSpecificIpUtil(pharm)}
                          </Typography>
                        </Box>
                      </TableCell>
                      <TableCell>
